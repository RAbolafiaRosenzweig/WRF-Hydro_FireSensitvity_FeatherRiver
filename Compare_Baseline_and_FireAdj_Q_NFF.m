...
current_station = 'NFP'; %station closest to outlet of middle fork feather
...
post_fire_start = datenum([2021 7 31]);
pre_fire_start = datenum([2018 11 1]);
...
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/Baseline_and_Realistic_NFF_Qanom_scatter.png')
...
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/Baseline_and_Realistic_NFF_Bias_Boxplot.png')
...
if p>0.001
    text(dates_prefire(1000),20,sprintf('R^{2}=%.2f (p=%.2f); NSE = %.2f; bias - %.2f',round(R^2,2),round(p,2),round(NSE,2),round(bias,2)),'fontsize',24,'color','b')
else
    text(dates_prefire(1000),20,sprintf('R^{2}=%.2f (p<0.001); NSE = %.2f; bias = %.2f',round(R^2,2),round(NSE,2),round(bias,2)),'fontsize',24,'color','b')
end
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/Baseline_NFF_Qanom_timeseries_prefire.png')
...
if p>0.001
    text(dates_postfire(100),3.5,sprintf('R^{2}=%.2f (p=%.2f); NSE = %.2f; bias = %.2f',round(R_baseline^2,2),round(p_baseline,2),round(NSE_baseline,2),round(bias_baseline,2)),'fontsize',24,'color','b')
else
    text(dates_postfire(100),3.5,sprintf('R^{2}=%.2f (p<0.001); NSE = %.2f;bias = %.2f',round(R_baseline^2,2),round(NSE_baseline,2),round(bias_baseline,2)),'fontsize',24,'color','b')
end
...
if p>0.001
    text(dates_postfire(100),2.8,sprintf('R^{2}=%.2f (p=%.2f); NSE = %.2f; bias = %.2f',round(R_realistic^2,2),round(p_realistic,2),round(NSE_realistic,2),round(bias_realistic,2)),'fontsize',24,'color','r')
else
    text(dates_postfire(100),2.8,sprintf('R^{2}=%.2f (p<0.001); NSE = %.2f; bias = %.2f',round(R_realistic^2,2),round(NSE_realistic,2),round(bias_realistic,2)),'fontsize',24,'color','r')
end
xtickangle(20)
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/NFF_Qanom_timeseries_postfire.png')
...
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/Baseline_NFF_Qanom_timeseries_prefire_monthly.png')
...
bias_baseline = nanmean(postfire_baseline - postfire_obs);
if p>0.001
    text(dates_postfire(10),0.2,sprintf('R^{2}=%.2f (p=%.2f); NSE = %.2f; bias = %.2f',round(R_baseline^2,2),round(p_baseline,2),round(NSE_baseline,2),round(bias_baseline,2)),'fontsize',20,'color','b')
else
    text(dates_postfire(10),0.2,sprintf('R^{2}=%.2f (p<0.001); NSE = %.2f; bias = %.2f',round(R_baseline^2,2),round(NSE_baseline,2),round(bias_baseline,2)),'fontsize',20,'color','b')
end
...
bias_realistic = nanmean(postfire_realistic - postfire_obs);
if p>0.001
    text(dates_postfire(10),0.0,sprintf('R^{2}=%.2f (p=%.2f); NSE = %.2f; bias = %.2f',round(R_realistic^2,2),round(p_realistic,2),round(NSE_realistic,2),round(bias_realistic,2)),'fontsize',20,'color','r')
else
    text(dates_postfire(10),0.0,sprintf('R^{2}=%.2f (p<0.001); NSE = %.2f; bias = %.2f',round(R_realistic^2,2),round(NSE_realistic,2),round(bias_realistic,2)),'fontsize',20,'color','r')
end
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/NFF_Qanom_timeseries_postfire_monthly.png')