...
pre_fire_end = datenum([2018 12 1]);
...
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/Baseline_and_Realistic_NFF_Qanom_scatter_baseline_Standardized.png')
...
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/Baseline_and_Realistic_NFF_Bias_Boxplot_baseline_Standardized.png')
...
% end
xtickangle(35)
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/Baseline_NFF_Qanom_timeseries_prefire_baseline_Standardized.png')
...
for j=1:length(idx1)-1
    ...
    store_stats = [store_stats;Mean_obs,current_R2,current_NSE,current_bias,max_obs];
end
...
idx_low_flow = find(store_stats(:,1) < 0 & store_stats(:,5) < 6 & store_stats(:,5) >4);
...
for k=1:length(idx_low_flow)
    ...
    text(current_dates(20),6.5,sprintf('R^{2}=%.2f; NSE = %.2f; bias = %.2f',round(R^2,2),round(NSE,2),round(bias,2)),'fontsize',30,'color','b')
    % if p>0.001
    ...
    % end
    xtickangle(35)
    saveas(f,sprintf('/Users/abolafia/ASO_Fire/Plots/PaperPlots/Baseline_NFF_Qanom_timeseries_prefire_Standardized_similarDryperiod%d.png',k))
end
store
ppp
...
% end
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/Baseline_NFF_Qanom_timeseries_prefire_monthly_baseline_Standardized.png')
...
% end
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/NFF_Qanom_timeseries_postfire_monthly_baseline_Standardized.png')