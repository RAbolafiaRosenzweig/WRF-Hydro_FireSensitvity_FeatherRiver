...
post_fire_start = datenum([2021 11 31]);
...
saveas(f,'/Users/abolafia/ASO_Fire/Plots/Baseline_and_Realistic_MFF_Qanom_scatter.png')
...
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/Baseline_and_Realistic_MFF_Bias_Boxplot.png')
...
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/Baseline_MFF_Qanom_timeseries_prefire.png')
...
xtickangle(20)
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/MFF_Qanom_timeseries_postfire.png')
...
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/Baseline_MFF_Qanom_timeseries_prefire_monthly.png')
...
bias_baseline = nanmean(postfire_baseline - postfire_obs);
if p>0.001
    text(dates_postfire(6),0.2,sprintf('R^{2}=%.2f (p=%.2f); NSE = %.2f; bias = %.2f',round(R_baseline^2,2),round(p_baseline,2),round(NSE_baseline,2),round(bias_baseline,2)),'fontsize',20,'color','b')
else
    text(dates_postfire(6),0.2,sprintf('R^{2}=%.2f (p<0.001); NSE = %.2f; bias = %.2f',round(R_baseline^2,2),round(NSE_baseline,2),round(bias_baseline,2)),'fontsize',20,'color','b')
end
...
bias_realistic = nanmean(postfire_realistic - postfire_obs);
if p>0.001
    text(dates_postfire(6),0.0,sprintf('R^{2}=%.2f (p=%.2f); NSE = %.2f; bias = %.2f',round(R_realistic^2,2),round(p_realistic,2),round(NSE_realistic,2),round(bias_realistic,2)),'fontsize',20,'color','r')
else
    text(dates_postfire(6),0.0,sprintf('R^{2}=%.2f (p<0.001); NSE = %.2f; bias = %.2f',round(R_realistic^2,2),round(NSE_realistic,2),round(bias_realistic,2)),'fontsize',20,'color','r')
end
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/MFF_Qanom_timeseries_postfire_monthly.png')