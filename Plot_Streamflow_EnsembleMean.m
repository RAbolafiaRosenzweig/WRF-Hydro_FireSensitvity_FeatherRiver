...
leg = legend([p01 p02 p03 p04 p05],{'Baseline','Mod-params','Mod-params+GVF','Mod-params+GVF+Veg-class','Mod-params+GVF+Veg-class+snow-alb'},'fontsize',28,'location','best');
leg.Position = [0.2810    0.4559    0.4802    0.1560];
grid on
box on
ylabel({'multi-year mean daily Q'; '(cfs) (2000-2022)'},'fontsize',22)
set(gca,'fontsize',22)
xlabel('day of water year','fontsize',22)
xlim([1 365])
...
grid on
box on
ylabel('\Delta multi-year daily Q (cfs) (2000-2022)','fontsize',22)
set(gca,'fontsize',22)
xlabel('day of water year','fontsize',22)
xlim([1 365])
...
f.Position = [ -1866        -299        1139        1096];
subplot(2,1,1)
title('East Branch North Fork Feather (station ICR)','fontsize',40)
hold on
...
f.Position = [ -1866        -299        1139        1096];
subplot(2,1,1)
title('North Fork Feather (station NFP)','fontsize',40)
hold on
