...
baseline_filename = sprintf('/Volumes/Pruina_External_Elements/ASO_Fire/Data/Analysis_Data/Catchment_averaged_outputs/baseline_LSM_outputs_Catch_3.mat');
realistic_filename = sprintf('/Volumes/Pruina_External_Elements/ASO_Fire/Data/Analysis_Data/Catchment_averaged_outputs/realistic_LSM_outputs_Catch_3.mat');
%baseline data
...
datetick('x','mm/yyyy','keepticks','keeplimits')
set(gca,'fontsize',36)
saveas(f,'/Users/abolafia/ASO_Fire/Plots/PaperPlots/NFF_Qanom_timeseries_postfire_baseline_Standardized_InDepth.png')
